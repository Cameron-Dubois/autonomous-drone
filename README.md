...
**LiteWing (ESP32-S3) Wi‑Fi / CRTP assumptions** (pairing, ports, and what to verify on hardware) live in the mobile app: [mobile/docs/litewing-pairing.md](mobile/docs/litewing-pairing.md).
